...
baxter_hostname="166.111.138.93"

# Set *Either* your computers ip address or hostname. Please note if using
# your_hostname that this must be resolvable to Baxter.
your_ip="166.111.138.117"
...
to the root of your catkin workspace.\n"
	...
	if [ ! -d "/home/robot/ros_catkin_ws" ] || [ ! "$(ls -A /home/robot/ros_catkin_ws)" ]; then
...
your_ip or your_hostname.\n"
	...
	ros_setup="/home/robot/ros_catkin_ws/\${ros_version}"
	if [ ! -d "\${ros_setup}" ]; then
